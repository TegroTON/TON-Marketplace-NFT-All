          ...
          <div class="col-lg-12 col-xl-9 col-xxl-7">
            ...
            <div class="row">
              <div class="col-lg-5 col-xl-4 order-2 order-lg-1 text-center text-lg-start">
                ...
                <div class="d-flex align-items-center border rounded-20 p-3 p-md-4 text-center position-sticky"
                     style="top: 140px; min-height: 380px">
                ...
                <form action="">
                  ...
                  <div class="mb-4">
                    ...
                    <div
                      ...
                      <div class="item-details__badge badge__green text-capitalize px-3 py-2 ms-sm-auto mb-3 mb-sm-0">
                        Connect
                      </div>
                    </div>
                  </div>
                  ...
                  <div class="bg-soft border rounded-20 p-4 mb-4">
                    <div class="mb-4">
                      ...
                      <input type="text" class="form-control" placeholder='e. g. "Redeemable T-Shirt with logo"'
                             required>
                    </div>
                    <div class="mb-0">
                      <h4 class="fs-16 mb-3">Description <span class="color-grey fs-14 ms-1">(Optional)</span></h4>
                      <textarea class="form-control p-3 mb-2"
                  ...
                  <div class="bg-soft border rounded-20 p-4 mb-4">
                    ...
                    <nav class="nav nav-pills nav-fill border rounded flex-column flex-sm-row" id="CreateTab"
                         role="tablist">
                      <a class="flex-sm-fill nav-link active" aria-current="page" href="#!" id="FixedPrice-tab"
                         data-bs-toggle="tab" data-bs-target="#FixedPrice" type="button" role="tab"
                         aria-controls="FixedPrice" aria-selected="true">
                        <i class="fa-regular fa-tag fs-24 me-2"></i>
                        <span class="d-block mt-2">Fixed price</span>
                      </a>
                      <a class="flex-sm-fill nav-link" href="#!" id="Openforbids-tab" data-bs-toggle="tab"
                         data-bs-target="#Openforbids" type="button" role="tab" aria-controls="Openforbids"
                         aria-selected="false">
                        <i class="fa-regular fa-infinity fs-24 me-2"></i>
                        <span class="d-block mt-2">Open for bids</span>
                      </a>
                      <a class="flex-sm-fill nav-link" href="#!" id="Timedauction-tab" data-bs-toggle="tab"
                         data-bs-target="#Timedauction" type="button" role="tab" aria-controls="Timedauction"
                         aria-selected="false">
                    ...
                    <div class="tab-content p-0" id="CreateTabContent">
                      <div class="tab-pane fade show active mt-4" id="FixedPrice" role="tabpanel"
                           aria-labelledby="FixedPrice-tab">
                        <div class="mb-4">
                      ...
                      <!--//-->
                      <div class="tab-pane fade mt-4" id="Openforbids" role="tabpanel"
                           aria-labelledby="Openforbids-tab">
                        <!--empty-->
                      </div>
                      <!--//-->
                      <div class="tab-pane fade mt-4" id="Timedauction" role="tabpanel"
                           aria-labelledby="Timedauction-tab">
                        <div class="mb-4">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 mt-3 fw-medium fs-14">
                            <p class="color-grey mb-1">Any bid placed in the last 10 minutes extends the auction by 10
                              minutes.</p>
                            <a href="#!" class="color-yellow" data-bs-toggle="modal"
                               data-bs-target="#HowAuctionsWorkModal">Learn more how timed auctions work.</a>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div class="mb-4">
                    ...
                    <div class="row mb-4">
                      <div class="col-12 col-sm-6 col-md-4">
                        <button type="button" class="btn btn-soft py-4 w-100" data-bs-toggle="modal"
                  ...
                  <div class="bg-soft border rounded-20 p-4">
                    ...
                    <div class="mb-0">
                      <h4 class="fs-16 mb-3">Alternative text for NFT <span
                          class="color-grey fs-14 ms-1">(Optional)</span></h4>
                      <textarea class="form-control p-3 mb-2"
                  ...
                  <div class="d-flex flex-column flex-sm-row align-items-center mt-4">
                    <button class="btn btn-primary" type="submit" data-bs-toggle="modal"
                            data-bs-target="#FollowStepsModal">Create item
                    </button>
