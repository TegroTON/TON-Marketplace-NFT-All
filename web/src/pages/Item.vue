          ...
          <div class="col-md-10 col-lg-12 col-xxl-9">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb mb-5 ms-3">
                ...
                <li aria-current="page" class="breadcrumb-item active">Tegro Cat #133</li>
              </ol>
            </nav>
            <div class="row justify-content-center mb-4">
              <div class="col-lg-5 col-xl-5 mb-4 mb-lg-0">
                ...
                <div class="position-sticky" style="top: 140px;">
                  <enlargeable-image src="assets/img/item-details-image.jpg"></enlargeable-image>
                </div>
                <!-- // End NFT Image -->
              </div>
              <div class="col-lg-7 col-xl-7">
                ...
                <div class="card-item-details border bg-soft p-4 rounded mb-4">
                  ...
                  <button class="btn btn-primary w-100" data-bs-target="#BuyNowModal" data-bs-toggle="modal"
                          type="button">Buy Now
                  </button>
                </div>
                <!-- // End Price Card -->
