<template>
  <header
    class="sticky z-40 top-0 py-6 sm:py-7 bg-opacity-80 bg-dark-900 backdrop-blur-2xl"
  >
    <div class="container relative mx-auto px-2.5">
      <nav class="relative flex flex-wrap p-0 items-center justify-between">
        <router-link
          class="flex items-center mr-12 no-underline text-gray-500"
          to="/"
        >
          <img
          ...
          />
          <span
            class="font-raleway text-3xl font-bold ml-6 text-white hidden 2xl:block"
            >Libermall</span
          >
        </router-link>
        ...
        <div
          ...
          class="left-0 top-0 px-3 py-6 lg:py-0 w-3/4 h-screen overflow-auto bg-dark-900 basis-full flex-grow items-center lg:h-auto lg:flex lg:basis-auto"
        >
          <form
            class="mb-4 xl:mb-0 mx-0 xl:mx-12 order-1 lg:order-2 flex-auto lg:hidden xl:block"
            disabled
          >
            <div
          ...
          <ul
            class="pl-0 mb-0 list-none pr-12 py-6 ml-0 lg:ml-auto order-2 lg:order-3 flex flex-row text-gray-500"
          >
            ...
            <ul aria-labelledby="dropdownMenuProfile" class="dropdown-menu">
              <li>
                <a class="dropdown-item" href="/my-profile.php"
                  ><i class="fa-regular fa-user me-3"></i>Profile</a
                >
              </li>
              <li>
