          ...
          <div class="col-lg-6">
            <div class="connect-thumbnail">
              <div class="left-image">
                <img :src="require(`@/assets/images/connect/connect-01.jpg`)" alt="Nft_Profile">
              </div>
            </div>
          </div>
          <div class="col-lg-6">
              ...
              <div class="col-xxl-4 col-lg-6 col-md-4 col-12 col-sm-6 col-12">
                <div class="wallet-wrapper">
                  <div class="inner">
                    ...
                    <div class="content">
                      <h4 class="title"><a href="#">Tonhub</a></h4>
...
export default {
  ...
  created() {
    this.connector.createNewSession({name: 'Market', url: 'https://69.69.69.69'})
        .then(s => {
          this.session = s
          console.log(s)
        })
