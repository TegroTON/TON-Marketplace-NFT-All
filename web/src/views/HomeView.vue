<template>
  ...
  <section class="relative py-12 sm:py-20">
    <carousel
        class="container text-center box-border mx-auto relative max-w-screen-2xl overflow-hidden mt-0 border-none p-0 sm:after:opacity-30 sm:after:blur-xl sm:border sm:border-gray-900 sm:rounded-3xl lg:mt-8">
      <carousel-slide class="relative float-left container transition-transform">
        <div class="flex flex-wrap justify-center">
          <h1 class="text-4xl sm:text-5xl font-bold mb-7">
            Discover the Exclusive <span class="block">NFT Collection</span>
          </h1>
          <div class="text-lg font-normal mb-10 text-gray-500 sm:text-2xl sm:font-light">
        ...
        <picture>
          ...
          <img alt="Libermall NFT Marketplace" class="hero__image" src="../assets/hero-image-1.jpg">
        </picture>
      </carousel-slide>
      <carousel-slide class="relative float-left container transition-transform">
        <div class="flex flex-wrap justify-center">
        ...
        <picture>
          ...
          <img alt="Libermall NFT Marketplace" class="hero__image" src="../assets/hero-image-2.jpg">
        </picture>
      </carousel-slide>
    </carousel>
  </section>
